...
async def edit_agent_card_endpoint(agent_uuid: str, update_data: AgentCreate, db: AsyncSession = Depends(get_db_session), _: None = Depends(get_current_user)):
...
async def edit_agent_endpoint(agent_uuid: str, update_data: AgentUpdate, db: AsyncSession = Depends(get_db_session), _: None = Depends(get_current_user)):
...
async def get_agent_by_uuid_endpoint(agent_uuid: str, db: AsyncSession = Depends(get_db_session), _: None = Depends(get_current_user)):
...
async def get_agents_by_creator_endpoint(user_uuid: str, db: AsyncSession = Depends(get_db_session), _: None = Depends(get_current_user)):
...
async def get_agent_by_id_endpoint(agent_id: int, db: AsyncSession = Depends(get_db_session), _: None = Depends(get_current_user)):
...
async def delete_agent_by_id_endpoint(agent_id: int, db: AsyncSession = Depends(get_db_session), _: None = Depends(get_current_user)):
...
async def delete_agent_by_uuid_endpoint(agent_uuid: str, db: AsyncSession = Depends(get_db_session), _: None = Depends(get_current_user)):
...
async def get_all_agents_endpoint(db: AsyncSession = Depends(get_db_session), _: None = Depends(get_current_user)):
