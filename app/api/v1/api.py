...
from .endpoints import agent_routes, client_routes, user_routes, workspace_routes, static_routes, prompt_management_routes, settings_routes, publish_routes
...
api_router.include_router(client_routes.router, tags=["chatbot"])
